                ...
                link: function (scope,element,attr,controller) {
                    ...
                    if (scope.$last === true) {
                        angular.element(element).ready(function() {
                                var src = attr.repeatFinished;
                                var oImage = new Image();
                                if(src=="null"){
                                     oImage.src = "./editingCenter/app/images/user_icon.jpg";
                                }else{
                                     oImage.src = src;
                                }
            ...
            return {
                ...
                link: function(scope,element){
                    ...
                    function scroll(){
                        ...
                        if (scrollTop + clientHeight-350 >= short) {
                    ...
                    function waterfall(minCols){
                        ...
                        var
                            colWidth,
                            oLis = element.children("li");
                            
                        if(oLis.length<=0||!oLis)return;
