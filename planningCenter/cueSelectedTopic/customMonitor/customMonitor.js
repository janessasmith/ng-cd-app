...
angular.module('customMonitorModule', ['customPreviewModule', 'addCustomMonitorModule', 'customMonitorModuleRouter', "planCenCustomMonitorServiceModule"])
    .controller('customMonitorController', ['$scope', '$sce', '$q', '$filter', 'localStorageService', 'trsHttpService', 'trsconfirm',
        function($scope, $sce, $q, $filter, localStorageService, trsHttpService, trsconfirm) {
            initStatus();
            initData();
            /**
            ...
            function initStatus() {
                ...
                $scope.page = {
                    pagesize: localStorageService.get("custommonitorPageSize") || 10
                };
            }
            /**
            ...
            $scope.setPageSize = function(pagesize) {
                ...
                localStorageService.set("custommonitorPageSize", pagesize);
                requestData();
            };
            /**
