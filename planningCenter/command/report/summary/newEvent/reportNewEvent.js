...
"use strict";
angular.module('planCenReportNewEventModule', [])
    .controller('planCenReportNewEventCtrl', ['$scope', '$timeout', '$filter', '$validation', '$state', '$compile', 'trsSelectItemByTreeService', 'trsspliceString', 'trsHttpService', 'trsconfirm', '$stateParams',
        function($scope, $timeout, $filter, $validation, $state, $compile, trsSelectItemByTreeService, trsspliceString, trsHttpService, trsconfirm, $stateParams) {
            initStatus();
            /**
            ...
            function initMap() {
                ...
                LazyLoad.js(["http://api.map.baidu.com/getscript?v=2.0&ak=rZkn12K1F24d0vsTopn6s2NGcQ5HurgK&services=&t=20160627141851"], function() {
                    // 百度地图API功能
                    $scope.map = new BMap.Map("map"); // 创建Map实例
