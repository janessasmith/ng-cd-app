angular.module("planCtrModalModule", ["reportModule", "pickReportsModule", "reportDetailsModule", "replyReportModule", "plancenterTaskModule","createInfoModule","createBroadcastInfoModule","plancenterInfoModule","addRemarkModule","infotypeModule"]).factory("planCtrModalService", function($modal) {
    return {
        ...
        replyReport: function(report,type) {
            var modalInstance = $modal.open({
        ...
        //新建广播信息页
        createBroadcastInfo: function(success) {
            var modalInstance = $modal.open({
                templateUrl: "./planningCenter/largeScreenControl/broadcast/service/createBroadcastInfo/createBroadcastInfo.html",
                windowClass: 'common-modal info-modal',
                size:'lg',
                backdrop: false,
                controller: "createBroadcastInfoCtrl",
                resolve: {}
            });
            modalInstance.result.then(function(result) {
                success(result);
        ...
        editInfoType: function(type) {
            var modalInstance = $modal.open({
                templateUrl: "./planningCenter/command/service/modal/createInfotype/editInfoType.html",
                windowClass: 'common-modal', 
                backdrop: false,
                controller: "editInfotypeCtrl",
                resolve: {
                    type:type
                }
            });
