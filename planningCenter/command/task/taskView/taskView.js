"use strict";
angular.module('planCenCommandTaskViewModule', ['acceptModalModule'])
    .controller('planCenCommandTaskViewCtrl', ['$scope', '$q', '$state', '$filter', 'trsHttpService', 'trsspliceString', 'trsconfirm', 'appointTaskService', '$modal', 'dateFilter', function($scope, $q, $state, $filter, trsHttpService, trsspliceString, trsconfirm, appointTaskService, $modal, dateFilter) {
        initStatus();
        initData();
        /**
        ...
        $scope.pageChanged = function() {
            $scope.params.CurrPage = $scope.page.jumptoPage = $scope.page.CURRPAGE;
            requestData();
        };
        /** [openAcceptModal 接受] */
