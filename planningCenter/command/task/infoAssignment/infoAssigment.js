...
angular.module('infoAssignmentModule', [])
    .controller('infoAssignmentCtrl', function($scope, $state, $location, dateFilter, trsspliceString, plancenterService, planCtrModalService, permissionService) {
        var vm = $scope.vm = {
            pageParams: {
                PageId: 1,
                PageSize:20
        ...
        var getPlanInfo = function() {
            ...
            plancenterService.infoinvoke('queryOwnerPlanInformations', params).then(function(res) {
                vm.infos = res.DATA;
                vm.pager = res.PAGER;
            });
        };
