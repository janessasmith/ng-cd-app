    /*
                                    ...
                                    */
    "use strict";
    angular.module("createBroadcastInfoModule", [])
        .controller("createBroadcastInfoCtrl", ["$scope", "$timeout", "$modalInstance", "trsHttpService", "trsconfirm", 'globleParamsSet', 'dateFilter', 'uploadAudioVideoService', function($scope, $timeout, $modalInstance, trsHttpService, trsconfirm, globleParamsSet, dateFilter, uploadAudioVideoService) {
            var info = $scope.info = {
                PlanInformationId: '',
                Title: null,
                Content: null,
