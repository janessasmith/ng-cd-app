...
angular.module('IMServiceMoudle', []).factory('IMService', ['$q', 'trsHttpService', 'versionCtrl', function($q, trsHttpService, versionCtrl) {
    return {
        ...
        initIM: function(appid) {
            var deferred = $q.defer();
            if (versionCtrl.isDebug||versionCtrl.isDev) appid = "8a48b55152f73add01532b8cd7a85b20";
        ...
        IMLogin: function(userid, sig, timeStamp) {
            ...
            if (versionCtrl.isDebug||versionCtrl.isDev) sig = hex_md5('8a48b55152f73add01532b8cd7a85b20' + userid + timeStamp + 'beb73534837882ef71536aad12732600');
