...
angular.module("trsWetchatTemplateServiceModule", []).factory("trsWetchatTemplateService", ['$templateRequest', '$q',
    function($templateRequest, $q) {
        var arrayObj = {
            contentTemplateNameArray: ["1.html", "2.html", "3.html", "4.html", "5.html", "6.html", "7.html", "8.html", "9.html",
            ...
            imageTextTemplateNameArray: ["1.html", "2.html", "3.html", "4.html", "5.html", "6.html", "7.html", "8.html", "9.html",
                "10.html", "11.html", "12.html", "13.html", "14.html", "15.html", "16.html", "17.html", "18.html", "19.html",
            ...
            titleTemplateNameArray: ["1.html", "2.html", "3.html", "4.html", "5.html", "6.html", "7.html", "8.html", "9.html",
                "10.html", "11.html", "12.html", "13.html", "14.html", "15.html", "16.html", "17.html", "18.html", "19.html",
         ...
         */
        function getTemplate(url, i, templateHtml, templateArray, TemplateNameArray, callback) {
            $templateRequest(url + templateArray[i]).then(
                function(html) {
                    i++;
                    var dom = document.createElement("div");
                    dom.innerHTML = html;
                    $($(dom).find("section")[0]).attr("ng-click", "getHtmlToUEditor($event)").attr("data-id", TemplateNameArray+i);
                    html = $(dom).html();
                    templateHtml += "<li style='display: block;'>" + html + "</li>";
                    if (i < templateArray.length) {
                        getTemplate(url, i, templateHtml, templateArray, TemplateNameArray, callback);
                    } else {
        ...
        return {
            ...
            getTemplate: function(name) {
                ...
                var i = 0;
                var templateHtml = "";
                getTemplate(urlMap[name], i, templateHtml, arrayObj[name + "TemplateNameArray"], name + "TemplateNameArray", function(data) {
                    deffer.resolve(data);
                });
