        ...
        link: function($scope, $element, $attrs) {
            ...
            $element.bind('dragstart', function(event) {
                ...
                if (json.value.CREATIONTYPE == 3) {
                    var srcImgUrlArray = json.value.SRCIMGURL.split("/");
                    if (srcImgUrlArray[srcImgUrlArray.length - 1].indexOf("_600.") > 0) {
                        srcImgUrlArray[srcImgUrlArray.length - 1] = srcImgUrlArray[srcImgUrlArray.length - 1].replace(/_600./g, ".");
                        json.value.SRCIMGURL = srcImgUrlArray.join("/");
                    }
