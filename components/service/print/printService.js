...
angular.module("trsPrintModule", ['util.httpService'])
    .factory("trsPrintService", ["$modal", function($modal) {
        return {
            ...
            trsAppPrintDocument: function(params) {
                var modalInstance = $modal.open({
                    template: "<div><trs_app_print></trs_app_print></div>",
                    windowClass: 'printCtrl',
                    backdrop: false,
                    controller: "trsAppPrintCtrl",
                    resolve: {
                        params: function() {
                            return params;
                        }
            ...
            trsWeixinPrintDocument: function(params) {
                var modalInstance = $modal.open({
                    template: "<div><trs_weixin_print></trs_weixin_print></div>",
                    windowClass: 'printCtrl',
                    backdrop: false,
                    controller: "trsWeixinPrintCtrl",
                    resolve: {
                        params: function() {
                            return params;
                        }
            ...
            trsPrintWeibo: function(params) {
                var modalInstance = $modal.open({
                    template: "<div><trs-print-Weibo></trs-print-Weibo></div>",
                    windowClass: 'printCtrl',
                    backdrop: false,
                    controller: "trsWeiboPrintCtrl",
                    resolve: {
                        params: function() {
                            return params;
                        }
    ...
    .directive('trsPrintWeibo', ["$compile", "trsHttpService", function($compile, trsHttpService) {
        return {
            restrict: 'E',
            templateUrl: "./components/service/print/template/printWeibo_tpl.html",
            link: function(scope, iElement, iAttrs) {
                // LazyLoad.js(["./lib/jquery-migrate/jquery-migrate.min.js", "./lib/jquery.jqprint/jquery.jqprint-0.3.js"], function() {
                //     $(iElement[0]).jqprint();
                // });
    ...
    .directive('trsAppPrint', ["$compile", "trsHttpService", function($compile, trsHttpService) {
        return {
            restrict: 'E',
            templateUrl: "./components/service/print/template/appPrint_tpl.html",
            link: function(scope, iElement, iAttrs) {
                // LazyLoad.js(["./lib/jquery-migrate/jquery-migrate.min.js", "./lib/jquery.jqprint/jquery.jqprint-0.3.js"], function() {
                //     $(iElement[0]).jqprint();
                // });
    ...
    .directive('trsWeixinPrint', ["$compile", "trsHttpService", function($compile, trsHttpService) {
        return {
            restrict: 'E',
            templateUrl: "./components/service/print/template/weixinPrint_tpl.html",
            link: function(scope, iElement, iAttrs) {
                // LazyLoad.js(["./lib/jquery-migrate/jquery-migrate.min.js", "./lib/jquery.jqprint/jquery.jqprint-0.3.js"], function() {
                //     $(iElement[0]).jqprint();
                // });
    ...
    .controller("trsWeiboPrintCtrl", ["$scope", "$modalInstance", "$timeout", "params", "$filter",
        function($scope, $modalInstance, $timeout, params, $filter) {
            initStatus();
            // $timeout(function() {
            //     print();
            ...
            //插入图片
            $scope.appendPic = function(item) {
                var imgArr = !!item.IR_THUMBNAIL_PIC ? item.IR_THUMBNAIL_PIC.split(';') : [];
                angular.forEach(imgArr, function(value, key) {
                    item.CONTENT += '<p><img src="' + value + '"/></p>';
                });
            };
            $scope.parseHang = function(doccount) {
                return Math.ceil(doccount / 27);
    ...
    .controller("trsAppPrintCtrl", ["$scope", "$modalInstance", "$timeout", "params", "$filter",
        function($scope, $modalInstance, $timeout, params, $filter) {
            initStatus();
            // $timeout(function() {
            //     print();
    ...
    .controller("trsWeixinPrintCtrl", ["$scope", "$modalInstance", "$timeout", "params", "$filter",
        function($scope, $modalInstance, $timeout, params, $filter) {
            initStatus();
            // $timeout(function() {
            //     print();
