 ...
 */
"use strict";
angular.module('logManageMentDistributeLogModule', [
        'logManageMentDistributeLogRouterModule',
    ])
    .controller('logManageMentDistributeLogCtrl', ['$scope', 'trsHttpService', 'initComDataService', 'dateFilter', "trsconfirm",
