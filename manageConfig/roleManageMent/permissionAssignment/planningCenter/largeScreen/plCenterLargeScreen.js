...
//描述：策划中心大屏控制授权
'use strict';
angular.module("manageCfg.roleManageMent.permissionAssignment.plCenterLargeScreenModule", [])
    .controller("plCenterLargeScreenCtrl", ["$scope", "$rootScope", "$modal", "$q", "trsHttpService", "permissionAssignmentService", "trsconfirm", "SweetAlert", function($scope, $rootScope, $modal, $q, trsHttpService, permissionAssignmentService, trsconfirm, SweetAlert) {
        //声明将要保存权限的数组对象开始
        var selecetedChanls = {};
        //声明将要保存权限的数组对象结束
        initStatus();
        ...
        function initData() {
            ...
            $scope.channelTree = [$rootScope.plCenterRight.treeData];
            initSelectNode();
