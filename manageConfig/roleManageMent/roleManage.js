    ...
    angular.module('roleManageModule', [
        ...
        .controller("roleManageMentCtrl", ['$scope', '$timeout', '$q', '$modal', '$compile', "$state", "trsHttpService", "SweetAlert", "trsconfirm", "permissionService", '$http', '$templateCache', "globleParamsSet", function($scope, $timeout, $q, $modal, $compile, $state, trsHttpService, SweetAlert, trsconfirm, permissionService, $http, $templateCache, globleParamsSet) {
            initStatus();
