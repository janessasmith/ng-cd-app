...
newspaperManageCtrl.$injector = ["$scope", "$state", "$filter", "$timeout", "$modal", "trsHttpService", "SweetAlert", "trsconfirm", "myManuscriptService", 'initSingleSelecet', 'editingCenterService', 'trsResponseHandle', 'trsspliceString', "initVersionService", "productMangageMentNewspaperService", "permissionService"];

function newspaperManageCtrl($scope, $state, $filter, $timeout, $modal, trsHttpService, SweetAlert, trsconfirm, myManuscriptService, initSingleSelecet, editingCenterService, trsResponseHandle, trsspliceString, initVersionService, productMangageMentNewspaperService, permissionService) {
    initStatus();
    initData();
    //下一页
    /**
