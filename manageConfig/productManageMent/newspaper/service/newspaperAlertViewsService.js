...
angular.module("productMangageMentNewspaperServiceModule", [
    ...
    .factory("productMangageMentNewspaperService", ["$modal", "$q", "trsHttpService", "globleParamsSet", function($modal, $q, trsHttpService, globleParamsSet) {
        return {
            //新建or编辑报纸
            manageNews: function(selectedItem, success) {
                var modalInstance = $modal.open({
                    ...
                    controller: "manageNewspaperCtrl"
                });
