...
*/
'use strict';
angular.module("manageConfigBatChooseChnlModule", [])
    .controller("manageConfigBatChooseChnlCtrl", ["$scope", "$filter", "$timeout", "$modalInstance", "trsHttpService", "chnlParams", "trsspliceString", "trsconfirm", function($scope, $filter, $timeout, $modalInstance, trsHttpService, chnlParams, trsspliceString, trsconfirm) {
        init();
        ...
        $scope.chooseChannel = function(node) {
            ...
            if ($scope.selectedChannels.indexOf(node) < 0) {
        ...
        $scope.confirm = function() {
            $modalInstance.close({
                ...
                ChannelNames: trsspliceString.spliceString($scope.selectedChannels, "CHNLDESC", ",")
            });
        };
        //点击单选框
