...
"use strict";
angular.module('editManuSourceAppModule', [])
    .controller('editManuSourceAppCtrl', ['$scope', '$validation', '$modalInstance', 'allData', 'trsconfirm', function($scope, $validation, $modalInstance, allData, trsconfirm) {
        initStatus();
