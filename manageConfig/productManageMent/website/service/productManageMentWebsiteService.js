...
angular.module("productManageMentWebsiteServiceModule", [
    ...
    .factory("productMangageMentWebsiteService", ["$q", "$modal", "localStorageService", "trsHttpService", "globleParamsSet", "trsconfirm", function($q, $modal, localStorageService, trsHttpService, globleParamsSet, trsconfirm) {
        return {
            //删除弹窗
            ...
            batChooseChnl: function(modalTitle, siteid, success, radio) {
                var modalInstance = $modal.open({
                    templateUrl: "./manageConfig/productManageMent/website/service/batChooseChnl/batChooseChnl_tpl.html",
