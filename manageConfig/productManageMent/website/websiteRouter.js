...
config(['$stateProvider', function($stateProvider) {
    $stateProvider.state("manageconfig.productmanage.website.site", {
        ...
        .state("manageconfig.productmanage.website.columndistribution", {
            url: '/columndistribution?channel&selecttab&parentchnl',
            views: {
                'main@manageconfig.productmanage.website': {
                    templateUrl: './manageConfig/productManageMent/website/columndistribution/columnDistribution_tpl.html',
                    controller: 'productManageMentWebsiteColumnDistributionCtrl'
                },
                'footer@manageconfig.productmanage.website': {
                    templateUrl: './manageConfig/productManageMent/website/footRouter_tpl.html',
                    controller: 'proMgrWebfooterRouterCtrl',
