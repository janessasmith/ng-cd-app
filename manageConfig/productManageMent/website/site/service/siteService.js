...
angular.module("mangeProSiteServiceModule", [])
    .controller("mangeProSiteModCtrl", ["$scope", "$modalInstance", "$stateParams", "params", "productMangageMentWebsiteService", "trsHttpService", "trsconfirm", function($scope, $modalInstance, $stateParams, params, productMangageMentWebsiteService, trsHttpService, trsconfirm) {
        initStatus();
        // console.log(params);
