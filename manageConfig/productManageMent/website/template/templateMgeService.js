...
angular.module("websiteTemplateServiceCtrlModule", [])
    .controller('websiteTemplateImportTemplateCtrl', ['$scope', "$modalInstance", "$stateParams", "initManageConSelectedService", "trsspliceString", "trsHttpService", "Upload", "trsconfirm", "host", function($scope, $modalInstance, $stateParams, initManageConSelectedService, trsspliceString, trsHttpService, Upload, trsconfirm, host) {
        init();
        initData();
        $scope.upload = function(file) {
            ...
            Upload.upload({
                ...
                $scope.status.progress = Math.ceil(progressPercentage*0.9);
