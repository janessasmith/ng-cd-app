...
config(['$stateProvider', function($stateProvider) {
    ...
    }).state("manageconfig.sysmanage.typemgr", { //稿库类型管理
        url: '/typemgr',
        views: {
            'main@manageconfig.sysmanage': {
                templateUrl: './manageConfig/sysManageMent/typeMgr/typeMgr_tpl.html',
                controller: 'manageSysManageTypeMgrCtrl'
            }
        }
    }).state("manageconfig.sysmanage.categorymgr", { //稿库类别管理
        url: '/categorymgr',
        views: {
            'main@manageconfig.sysmanage': {
                templateUrl: './manageConfig/sysManageMent/categoryMgr/categoryMgr_tpl.html',
