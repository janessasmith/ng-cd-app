...
config(['$stateProvider',function ($stateProvider) {
    ...
    }).state("manageconfig.sysmanage.classifieddictionary.politicalcommSense", {
        url:'/politicalcommSense?type&name',
        views:{
            'main@manageconfig.sysmanage.classifieddictionary':{  
                templateUrl:'./manageConfig/sysManageMent/classifiedDictionary/politicalcommSense/politicalcommSense_tpl.html',
                controller:'politicalcommSenseCtrl'
            }
        }
    });/*.
