        ...
        .factory('fgDelegate', [function() {
            ...
            Flow.prototype.fillColumns = function() {
                ...
                for (var columnIdx = 0; columnIdx < columnsCnt; columnIdx++) {
                    ...
                    this.columnsHeights[columnIdx] = columnIdx;
                }
                for (var itemIdx = 0; itemIdx < itemsCnt; itemIdx++) {
                    ...
                    var lowestColumn = this.columnsHeights.indexOf(Math.min.apply(null, this.columnsHeights));
                    this.columns[lowestColumn].appendChild(item);
                    // record their height
