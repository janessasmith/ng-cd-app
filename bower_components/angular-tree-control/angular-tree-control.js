    ...
    angular.module('treeControl', [])
        ...
        .directive('treecontrol', ['$compile', function($compile) {
            ...
            return {
                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', '$http', '$q', function($scope, $templateCache, $interpolate, treeConfig, $http, $q) {
                    ...
                    $scope.selectNodeLabel = function(selectedNode) {
                        /*console.log($scope.selectedNodeCompare);
                        console.log(JSON.stringify(selectedNode));*/
                        /*$scope.selectedNodeCompare = JSON.stringify($scope.selectedNode);
                        if (JSON.stringify(selectedNode) !== $scope.selectedNodeCompare) {*/
                        var transcludedScope = this;
                    ...
                    $scope.treeEyes = function(node, flag) {
                        //if (node === $scope.selectedNode) return;
                        node.flag = flag;
                    };
