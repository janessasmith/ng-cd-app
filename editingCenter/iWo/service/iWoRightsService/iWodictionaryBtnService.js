...
factory("iWoBtnService", ["trsHttpService", function(trsHttpService) {
    return {
        /**
         * [initIwoPersonBtn description]个人稿库权限
        ...
        initIwoPersonBtn: function() {
            var btnRights = {
                ...
                484: {
                    "OPERDESC": "提交",
                    "OPERNAME": "personalDraft"
                }
            };
            return btnRights;
        },
        /**
         * [initIwoReceiveBtn description]已收稿库权限
         * @return {[type]} [description]
         */
        ...
        /**
         * [initIwoDepartmentBtn description]部门稿库权限
         * @return {[type]} [description]
         */
        initIwoDepartmentBtn: function() {
            var btnRights = {
                475: {
                    "OPERDESC": "上栏",
                    "OPERFUN": "departmentShangLan"
                },
                476: {
                    "OPERDESC": "传递",
                    "OPERFUN": "departmentChuanDi"
                },
                477: {
                    "OPERDESC": "共享",
                    "OPERFUN": "departmentGongXiang"
                },
                478: {
                    "OPERDESC": "退稿",
                    "OPERFUN": "departmentTuiGao"
                },
                479: {
                    "OPERDESC": "发稿单",
                    "OPERFUN": "departmentFaGaoDan"
                },
                480: {
                    "OPERDESC": "导出",
                    "OPERFUN": "departmentDaoChu"
                },
                481: {
                    "OPERDESC": "编辑",
                    "OPERFUN": "departmentBianJi"
                },
                482: {
                    "OPERDESC": "提交",
                    "OPERFUN": "departmentTiJiao"
                },
                483: {
                    "OPERDESC": "管理",
                    "OPERFUN": "departmentGuanLi"
                }
            };
            return btnRights;
        }
