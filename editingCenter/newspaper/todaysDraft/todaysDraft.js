...
angular.module('newspaperTodaysDraftModule', ["newspaperTodaysDraftRouterModule"])
    .controller('newspaperTodaysDraftCtrl', ["$scope",'$location','$filter', '$state', "$stateParams", '$window', '$cacheFactory', '$q', "$modal", "trsHttpService", "SweetAlert", "initSingleSelecet", "editNewspaperService", "trsspliceString", "trsconfirm", "editingCenterService", "editcenterRightsService", "$interval", "initVersionService", "trsPrintService", "localStorageService", "storageListenerService", "globleParamsSet", "editIsLock",
        function($scope,$location,$filter, $state, $stateParams, $window, $cacheFactory, $q, $modal, trsHttpService, SweetAlert, initSingleSelecet, editNewspaperService, trsspliceString, trsconfirm, editingCenterService, editcenterRightsService, $interval, initVersionService, trsPrintService, localStorageService, storageListenerService, globleParamsSet, editIsLock) {
            initStatus();
            init();
            ...
            function initDropDown() {
                ...
                $scope.data.conditionsSearch = initSingleSelecet.newspaperEntire();
                $scope.data.selectedConditions = angular.copy(initSingleSelecet.newspaperEntire()[0]);
            }
            ...
            function getESSearchParams() {
                var esParams = {
                    ...
                    searchParams: {
                        ...
                        searchFields: [{
                            searchField: $scope.data.selectedConditions.value,
