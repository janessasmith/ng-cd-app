...
angular.module('editCenWebsiteSigedPushBarModule', [])
    .controller('editCenWebsiteSigedPushBarCtrl', ['$scope', '$modalInstance', "trsHttpService", 'trsconfirm', 'title', function($scope, $modalInstance, trsHttpService, trsconfirm, title) {
        initStatus();
        initDatas();
        //确认
