...
*/
'use strict';
angular.module("websiteServiceModule", ["singleChooseChnlModule", "stickModule", "contentExpansionModule", 'editCenWebsiteSigedPushBarModule', 'editCenWebsiteSigedPushBarToMlfModule', 'editWebsteSubjectViewModule', 'editWebsteAscriptionViewModule']).
factory("websiteService", ["$modal", "trsHttpService", "trsconfirm", function($modal, trsHttpService, trsconfirm) {
    return {
        ...
        pushBar: function(title, success) {
            var modalInstance = $modal.open({
        ...
        pushBarToMlf: function(title, success) {
            var modalInstance = $modal.open({
                templateUrl: "./editingCenter/website/service/pushBar/pushBar_tpl.html",
                windowClass: 'editCen-website-signed-pushBar',
                backdrop: false,
                controller: "editCenWebsiteSigedPushBarToMlfCtrl",
                resolve: {
                    title: function() {
                        return title;
                    }
