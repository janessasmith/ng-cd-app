...
controller('EditCenterAtlasController', ["$scope", '$compile', '$window', 'localStorageService', '$q', "$anchorScroll", "$timeout", "$modal", "$stateParams", "$validation", "$state", "trsHttpService", "initAddMetaDataService", "initVersionService", "jsonArrayToStringService", "trsconfirm", "trsResponseHandle", "initeditctrBtnsService", "editingCenterAppService", "editingCenterService", "storageListenerService", "initAppRequiredBtnService", "appDictionaryBtnService", "filterEditctrBtnsService", "trsspliceString", "editIsLock", "editPictureService", "trsSelectDocumentService",
    function($scope, $compile, $window, localStorageService, $q, $anchorScroll, $timeout, $modal, $stateParams, $validation, $state, trsHttpService, initAddMetaDataService, initVersionService, jsonArrayToStringService, trsconfirm, trsResponseHandle, initeditctrBtnsService, editingCenterAppService, editingCenterService, storageListenerService, initAppRequiredBtnService, appDictionaryBtnService, filterEditctrBtnsService, trsspliceString, editIsLock, editPictureService, trsSelectDocumentService) {
        ...
        function dealAttribute() {
            ...
            list.LISTPICS = angular.copy(jsonArrayToStringService.clearEmptyArray(list.LISTPICS)); //图片处理
            list.RELEVANTNEWSIDS = trsspliceString.spliceString($scope.data.relNewsSelectedItems, 'METADATAID', ","); //相关新闻处理
        ...
        /**
         * [moveUploadImg description]图片的拖动排序
         * @param  {[str]} index  [description]图片的下标
         * @return {[type]}       [description]
         */
