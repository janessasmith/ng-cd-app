...
angular.module('editingCenterAddWebsiteModule', [])
    .controller('EditingCenterAddWebsiteController', ['$scope', '$q', '$state',
        ...
        'jsonArrayToStringService', 'trsconfirm', "$validation", 'initeditctrBtnsService', 'editingCenterAppService', 'editingCenterService', 'initAppRequiredBtnService', 'editcenterRightsService', 'filterEditctrBtnsService', 'appDictionaryBtnService', 'editIsLock', "localStorageService",
        function($scope, $q, $state, $modal, $location, $stateParams, $anchorScroll, $window,
            ...
            $validation, initeditctrBtnsService, editingCenterAppService, editingCenterService, initAppRequiredBtnService, editcenterRightsService, filterEditctrBtnsService, appDictionaryBtnService, editIsLock, localStorageService) {
            /*初始化*/
            initStatus();
            initData();
