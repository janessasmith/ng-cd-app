            ...
            return {
                ...
                draftPublish: function(chnldocid) {
                    ...
                    trsHttpService.httpServer("/wcm/mlfcenter.do", view, "post").then(function(data) {
                        data.EXCEPTIONDETAIL ? trsconfirm.alertType('预览失败', data.EXCEPTIONDETAIL.substr(0, 500) + '...', 'error', false) : $window.open(data.URLS);
                    });
                },
                //按照栏目ID遍历栏目树中的栏目
                ...
                batChooseChnl: function(modalTitle, siteid, success, radio) {
                    var modalInstance = $modal.open({
                        templateUrl: "./editingCenter/service/batChooseChnl/batChooseChnl_tpl.html",
