"use strict";
angular.module('editctrInitBtnModule', []).factory('initeditctrBtnsService', ['$state', 'trsHttpService', '$q', function($state, trsHttpService, $q) {
    return {
        ...
        initIwoData: function(ModalName) {
            var params = {
                "serviceid": $state.params.departmentid ? 'nb_managerconfig' : "mlf_metadataright",
                "methodname": $state.params.departmentid ? 'findDepartmentReleaseRight' : "findMyOperRightByModal",
                "ModalName": $state.params.departmentid ? null : ModalName,
