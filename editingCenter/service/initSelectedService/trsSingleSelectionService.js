...
angular.module('initSingleSelectionModule', []).factory('initSingleSelecet', ['trsHttpService', '$q', function(trsHttpService, $q) {
    return {
        ...
        //素材库ES检索条件
        meterailESCondition: function() {
            var meterailEntireJsons = [{
                name: "全部",
                value: "Allrocerd"
            }, {
                name: "ID",
            ...
            return meterailEntireJsons;
        },
        //官员库搜索条件
        officerSearchCondition: function() {
            var officerSearchJsons = [{
                name: "名称",
                value: "Name"
            }, {
                name: "职位",
            ...
            return officerSearchJsons;
        },
        //I我稿件收藏全部
        ManuCollEntire: function() {
            var ManuCollEntireJsons = [{
                name: "全部",
                value: ""
            }, {
                name: "ID",
        ...
        //报纸全部 创建人
        newspaperEntire: function() {
            var newspaperEntireJsons = [{
                name: "全部",
                value: ""
            }, {
                name: "ID",
        ...
        /**
         * [appDocType description]app稿件文档类型
        ...
        //微信全部
        weixinEntire: function() {
            var weixinEntireJsons = [{
                name: "全部",
                value: ""
            }, {
                name: "ID",
            ...
            return weixinEntireJsons;
        },
        //微信废稿全部
        weixinRecycleEntire: function() {
            var weixinRecycleEntireJsons = [{
                name: "全部",
                value: ""
            }, {
                name: "ID",
            ...
            return weixinRecycleEntireJsons;
        },
        //微信公众号类型
        weixinPublicNumberType: function() {
            var publicNumberType = [{
                name: '服务号',
                value: '1'
            }, {
                name: '订阅号',
