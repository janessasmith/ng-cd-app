...
factory('WeiXininitService', ['$q', 'trsHttpService', function($q, trsHttpService) {
    return {
        ...
        /**
         * [queryAccountInfo description] 查询单个微信账号信息
         * @param  {[string]} channelid [description] 要查询的公众号栏目id
         * @return {[object]} [description] 账号信息promise
         */
        queryAccountInfo: function(channelid) {
            var deffer = $q.defer();
            var params = {
